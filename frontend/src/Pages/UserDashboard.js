    ...
    return (
      <div className="">
        ...
        <div className="flex  overflow-x-hidden overflow-y-hidden">
          <div className="w-[590px] ml-28 mt-20 p-6  rounded shadow-lg">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4 ">
                <label
                  htmlFor="name"
                  className="block text-gray-700 hover:bg-[#d6f2f6]  font-bold mb-2"
                >
                  Name:
                </label>
                <input
          ...
          <div className="absolute top-10 right-10 ">
            <img src={logo} width={800} height={400}></img>
          </div>
        </div>
      </div>
    );
